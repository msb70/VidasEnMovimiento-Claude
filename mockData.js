...
const ORGANIZACIONES = [
  {
    id: 'ORG01',
    nombre: 'Casa del Migrante Caracas',
    paisId: 'VE', ciudadId: 'CCS',
    tipo: 'ONG local',
    contacto: 'María Elena Suárez',
    email: 'contacto@casamigranteccs.org',
    telefono: '+58 212 4421100',
    servicios: ['TS01','TS02','TS05'],
    totalAtendidos: 312, activa: true, recomendaciones: 29,
    descripcion: 'Primera línea de atención en Caracas para migrantes en preparación de salida.'
  },
  {
    id: 'ORG02',
    nombre: 'Red Humanitaria Maracaibo',
    paisId: 'VE', ciudadId: 'MAR',
    tipo: 'ONG local',
    contacto: 'Carlos Fuenmayor',
    email: 'info@redhumanitaria-mar.org',
    telefono: '+58 261 7853390',
    servicios: ['TS01','TS03','TS04'],
    totalAtendidos: 198, activa: true, recomendaciones: 17,
    descripcion: 'Atiende migrantes en zona fronteriza occidente venezolano.'
  },
  {
    id: 'ORG03',
    nombre: 'Pastoral Social Cúcuta',
    paisId: 'CO', ciudadId: 'CUC',
    tipo: 'Religiosa',
    contacto: 'Padre Hernán Leal',
    email: 'pastoral@cucuta.org',
    telefono: '+57 7 5712234',
    servicios: ['TS01','TS02','TS03','TS05'],
    totalAtendidos: 541, activa: true, recomendaciones: 61,
    descripcion: 'Mayor punto de entrada en Colombia. Atención 24h en frontera.'
  },
  {
    id: 'ORG04',
    nombre: 'Fundación ACNUR Colombia',
    paisId: 'CO', ciudadId: 'BOG',
    tipo: 'Internacional',
    contacto: 'Alejandra Ríos',
    email: 'colombia@acnur.org',
    telefono: '+57 1 6257900',
    servicios: ['TS03','TS04','TS05','TS07','TS08'],
    totalAtendidos: 834, activa: true, recomendaciones: 94,
    descripcion: 'Hub central de derivación y atención integral en Bogotá.'
  },
  {
    id: 'ORG05',
    nombre: 'Albergue Puente Panamá',
    paisId: 'PA', ciudadId: 'PTY',
    tipo: 'ONG regional',
    contacto: 'Roberto Gutiérrez',
    email: 'contacto@alberguepuente.pa',
    telefono: '+507 213 4456',
    servicios: ['TS01','TS02','TS03','TS06'],
    totalAtendidos: 407, activa: true, recomendaciones: 48,
    descripcion: 'Atención tras cruce del Darién. Refugio de emergencia y salud.'
  },
  {
    id: 'ORG06',
    nombre: 'Cruz Roja Panamá — David',
    paisId: 'PA', ciudadId: 'DAV',
    tipo: 'Cruz Roja',
    contacto: 'Ingrid Morales',
    email: 'david@cruzroja.pa',
    telefono: '+507 775 2233',
    servicios: ['TS03','TS04','TS06'],
    totalAtendidos: 276, activa: true, recomendaciones: 33,
    descripcion: 'Punto de atención médica y psicológica en tránsito hacia Costa Rica.'
  },
  {
    id: 'ORG07',
    nombre: 'Centro de Acogida San José',
    paisId: 'CR', ciudadId: 'SJO',
    tipo: 'ONG regional',
    contacto: 'Ximena Badilla',
    email: 'acogida@centrosanjose.cr',
    telefono: '+506 2221 8844',
    servicios: ['TS01','TS02','TS04','TS05','TS07'],
    totalAtendidos: 359, activa: true, recomendaciones: 41,
    descripcion: 'Atención integral y asesoría migratoria en Costa Rica.'
  },
  {
    id: 'ORG08',
    nombre: 'Casa Migrante Tapachula',
    paisId: 'MX', ciudadId: 'TAP',
    tipo: 'Religiosa',
    contacto: 'Fray Tomás Espinoza',
    email: 'casamigrante@tapachula.mx',
    telefono: '+52 962 6266543',
    servicios: ['TS01','TS02','TS03','TS05'],
    totalAtendidos: 623, activa: true, recomendaciones: 72,
    descripcion: 'Primera atención en México tras cruce de frontera sur.'
  },
  {
    id: 'ORG09',
    nombre: 'OIM México — CDMX',
    paisId: 'MX', ciudadId: 'CDM',
    tipo: 'Internacional',
    contacto: 'Dr. Luis Valenzuela',
    email: 'mexico@iom.int',
    telefono: '+52 55 5523 7044',
    servicios: ['TS04','TS05','TS07','TS08'],
    totalAtendidos: 489, activa: true, recomendaciones: 55,
    descripcion: 'Coordinación regional, asesoría legal y reinserción laboral.'
  },
  {
    id: 'ORG10',
    nombre: 'RAICES Foundation Houston',
    paisId: 'US', ciudadId: 'HOU',
    tipo: 'ONG local',
    contacto: 'Sandra Villarreal',
    email: 'info@raicesfoundation.org',
    telefono: '+1 713 880 0800',
    servicios: ['TS05','TS07','TS08'],
    totalAtendidos: 217, activa: true, recomendaciones: 26,
    descripcion: 'Apoyo legal y laboral para migrantes en proceso de regularización en EE.UU.'
  },
  {
    id: 'ORG11',
